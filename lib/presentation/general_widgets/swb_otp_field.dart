...
class SwbOtpField extends StatefulWidget {
  const SwbOtpField({
    super.key,
    this.label,
    this.onChanged,
  ...
  final bool readOnly;
  final bool hasError;
  final SwbPinTheme? pinTheme;
  final SwbPinTheme? focusedPinTheme;
  final TextEditingController? controller;
  final SwbPinTheme? followingPinTheme;
  final SwbPinTheme? submittedPinTheme;
  ...
  @override
  State<SwbOtpField> createState() => _SwbOtpFieldState();
}

class _SwbOtpFieldState extends State<SwbOtpField> {
  ...
  SwbPinTheme get defaultPinTheme => SwbPinTheme(
        context: context,
        width: widget.boxWidth,
        height: widget.boxHeight,
      );

  SwbPinTheme get errorPinTheme => SwbPinTheme(
        context: context,
  ...
  SwbPinTheme get submittedPinTheme => SwbPinTheme(
        context: context,
        width: widget.boxWidth,
        height: widget.boxHeight,
      );

  SwbPinTheme get focusedPinTheme => SwbPinTheme(
        context: context,
        width: widget.boxWidth,
        height: widget.boxHeight,
      );
...
class SwbPinTheme extends PinTheme {
  SwbPinTheme({
    required this.context,
    double width = 72,
    double height = 50,
    Color color = AppColors.primary292929,
  }) : super(
          width: width,
          height: height,
